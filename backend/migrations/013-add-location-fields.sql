...
-- Created: 2026-01-26
-- Description: Adds district, zone, and division fields to support admin dashboard
...
CREATE INDEX `idx_farmer_location` ON `farmer_details` (`zone`);
CREATE INDEX `idx_instructor_area` ON `instructor_details` (`zone`);
