...
// Demo account identifiers — allows re-registration without corrupting demo data.
// These are automatically empty in production (NODE_ENV=production), so demo bypass
